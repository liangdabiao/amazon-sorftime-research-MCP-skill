...
|------|------|------|----------|-----------|----------|
| **否定/敏感词** | 69 | 6.0% | 677,839 | 10,117.0 | 直接否定 |
| **品牌词** | 13 | 1.1% | 118,250 | 9,096.0 | 竞品打法/否定 |
| **材质词** | 24 | 2.1% | 55,538 | 3,967.0 | 精准匹配 |
| **使用场景词** | 75 | 6.6% | 1,199,624 | 18,176.0 | 场景分组 |
| **属性修饰词** | 274 | 24.0% | 1,574,234 | 7,288.0 | 长尾精准 |
| **功能词** | 110 | 9.6% | 3,490,708 | 34,561.0 | 广泛匹配 |
| **核心产品词** | 337 | 29.5% | 10,512,652 | 37,279.0 | 大词投放 |
| **其他** | 240 | 21.0% | 2,591,279 | 11,725.0 | 补充埋词 |
...
| 材质 | 属性 | 组合示例 |
|------|------|----------|
| velvet / velvet needoh / velvet needoh squeeze | mini / mini needoh / mini needoh cube | 组合使用 |
...
- **场景组 1**: 围绕 `baby` 展开投放
- **场景组 2**: 围绕 `baby toys` 展开投放
- **场景组 3**: 围绕 `baby toy` 展开投放
- **场景组 4**: 围绕 `baby needoh` 展开投放
- **场景组 5**: 围绕 `baby squishy` 展开投放
